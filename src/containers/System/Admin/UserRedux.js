                        ...
                        <div className='row'>
                            ...
                            <div className='col-3'>
                                ...
                                <div className='preview-img-container'>
                                    ...
                                    />
                                    <label className="label-upload" for="previewImg">Tải ảnh <i className='fas fa-upload'></i></label>
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        fetUsersRedux: () => dispatch(actions.fetchAllUsersStart()),
